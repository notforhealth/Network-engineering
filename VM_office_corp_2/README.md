...
- [Импортирование всех виртуальных машин](#установка-всех-виртуальных-машин)
- [Настройка сетевых адаптеров](#настройка-сетевых-адаптеров)
- [Установка ОС](#установка-ос)
- [Настройка pfSense](#настройка-opnsense)
- [Настройка DNS сервера](#настройка-debian)
- [Настройка DHCP сервера](#настройка-dhcp)
